...
## [1.2.0] - 2026-07-13
### Added
- `SQSHandler.handle()` now receives the AWS Lambda context as third argument and sets the `AWS_LAMBDA_REQUEST_ID` env var with the `awsRequestId` on every invocation
